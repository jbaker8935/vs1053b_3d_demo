...
static void emit_struct_offsets(void) {
    ...
    EMIT_EQU(MODEL3D_FACE_COUNT, offsetof(Model3D, face_count));
    EMIT_EQU(MODEL3D_FACE_NX, offsetof(Model3D, face_nx));
    EMIT_EQU(MODEL3D_FACE_NY, offsetof(Model3D, face_ny));
    EMIT_EQU(MODEL3D_FACE_NZ, offsetof(Model3D, face_nz));
    EMIT_EQU(MODEL3D_EDGE_FACE0, offsetof(Model3D, edge_face0));
    EMIT_EQU(MODEL3D_EDGE_FACE1, offsetof(Model3D, edge_face1));
    EMIT_EQU(MODEL3D_SIZE, sizeof(Model3D));
    EMIT_EQU(MODEL3D_MAX_VERTICES, MODEL3D_MAX_VERTICES);
    EMIT_EQU(MODEL3D_MAX_FACES, MODEL3D_MAX_FACES);
